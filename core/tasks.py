...
def scraper_operating_performance(ticker_value, market_value):
    ...
    a_file.close()
    pd.read_json("operating_performance.json").to_excel('operating_performance.xls')
    sleep(5)
...
def scraper_dividends(ticker_value,market_value):
    ...
    a_file.close()
    pd.read_json("dividends.json").to_excel('dividends.xls')
    sleep(5)
...
def scraper_valuation(ticker_value,market_value,download_type):
    ...
    if download_type == "VALUATION_CASH_FLOW": 
        ...
        a_file.close()
        pd.read_json("valuation_cash_flow.json").to_excel('valuation_cash_flow.xls')
        sleep(5)
        ...
        a_json = json.load(a_file)
        a_file.close()
        pd.read_json("valuation_growth.json").to_excel('valuation_growth.xls')
        sleep(5)
        valuation_driver.quit() 
        return 'DONE'      
        ...
        a_json = json.load(a_file)
        a_file.close()
        pd.read_json("valuation_financial_health.json").to_excel('valuation_financial_health.xls')
        sleep(5)
        valuation_driver.quit()  
        return 'DONE'    
        ...
        a_json = json.load(a_file)
        pd.read_json("valuation_operating_efficiency.json").to_excel('valuation_operating_efficiency.xls')
        a_file.close()
        sleep(5)
        valuation_driver.quit()      
